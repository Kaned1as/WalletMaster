...
/**
 * Stub authenticator component for sync. Mandatory as Android Framework requires it.
 * 
 * @author Adonai
 * @author Android Developers
 */
public class WalletAccountAuthenticator extends AbstractAccountAuthenticator {
    
    // Simple constructor
    public WalletAccountAuthenticator(Context context) {
        super(context);
    }
